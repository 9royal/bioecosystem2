...
export const ECOSYSTEM_TABS: EcosystemTab[] = [
  ...
  { id: 'submit', label: '上傳積分', icon: 'CheckCircle2', color: 'bg-slate-800', locked: true },
  { id: 'creature-challenge', label: '生物挑戰', icon: 'Zap', color: 'bg-red-500', locked: false },
  { id: 'ecosystem-challenge', label: '生態挑戰', icon: 'Zap', color: 'bg-orange-500', locked: false },
];
